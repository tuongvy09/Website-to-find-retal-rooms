    ...
    return (
        <div className="intro-container">
            <div className="intro-left">
                <Typography className='intro-left-title'>Tìm Trọ Đơn Giản và Tiện Lợi</Typography>
                <div className="feature-item">
                    <img src={securityIcon} alt="An toàn" className="feature-icon" />
                    <div className="feature-text">
                        <h3 className='intro-left-title1'>An toàn và Uy tín</h3>
                        <p className='intro-left-content'>Chúng tôi cam kết cung cấp thông tin phòng trọ chính xác và đáng tin cậy từ các chủ nhà có uy tín.</p>
                    </div>
                </div>
                <div className="feature-item">
                    ...
                    <div className="feature-text">
                        ...
                        <p className='intro-left-content'>Chúng tôi luôn tìm kiếm các phòng trọ với mức giá phù hợp với nhu cầu của bạn, đảm bảo tính cạnh tranh và hợp lý.</p>
                    </div>
                </div>
                <div className="feature-item">
                    <img src={contactIcon} alt="Dễ dàng liên hệ" className="feature-icon" />
                    <div className="feature-text">
                        <h3 className='intro-left-title1'>Dễ Dàng Liên Hệ</h3>
                        <p className='intro-left-content'>Liên hệ trực tiếp với chủ nhà thông qua nền tảng của chúng tôi để đàm phán và thỏa thuận nhanh chóng.</p>
                    </div>
                </div>
            </div>
