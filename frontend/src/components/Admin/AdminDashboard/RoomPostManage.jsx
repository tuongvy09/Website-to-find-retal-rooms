...
const RoomPostManage = ({ post, onTitleClick, onApprove, onReject, onHide, onVisible}) => {
  return (
    <Card className="room-post-card">
      ...
      <CardContent className="room-post-content">
        ...
        {post.status === 'approved' && post.visibility === 'visible' && (
          <Box className="manage-post-admin-btn-container">
            <Button className="manage-post-admin-btn-hide" onClick={() => onHide(post.id)}>
              Ẩn
            </Button>
          </Box>
        )}
        {post.status === 'approved' && post.visibility === 'hidden' && (
          <Box className="manage-post-admin-btn-container">
            <Button className="manage-post-admin-btn-hide" onClick={() => onVisible(post.id)}>
              Hiện bài đăng
            </Button>
          </Box>
        )}
