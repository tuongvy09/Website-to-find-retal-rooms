       ...
       <h2>Chi tiết tin tức</h2>
        <div className="cover-upload">
          ...
          <div className="image-preview">
              {
                imagePreview ?  <img src={imagePreview} alt="Preview" />:  <p className="image-waiting"><img src={require('../../../../assets/images/home.png')} alt="Preview" /></p>
              }
            </div>
          ...
          <form onSubmit={handleSubmit}>
           ...
           <div className="news-btn"> <button type="submit" className="submit-button">Thêm tin</button></div>
          </form>
        </div>
      </div>
    </div>
